...
Socket Studio is a service designed to make adding sound effects to your Twitch™ streams feel like deploying serverless functions.

> ⚠️ This product is still in alpha. If you’d like to be added as an alpha tester, please contact <jason@lengstorf.com>.

## How it works

1. Join Socket Studio
...
### Creating a Socket Studio serverless handler
...
3.  Register your serverless function
    ...
    Visit your [Socket Studio dashboard](/) to pull in your effects!
